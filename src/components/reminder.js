...
export class Reminder extends React.Component {
  render() {
    return	<div className='Reminder'>
        ...
        <p><strong>Scores are based on observation:</strong> You can only be evaluated based on what is observed within the scope of what you do for GroupBy. The opportunity to prove yourself will come in time.</p>
    	</div>
  }
}