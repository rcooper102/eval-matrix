...
export const LEADERSHIP = [
  ...
  },
  {
    type: QUESTION_TYPES.AGREE,
    title: `Interviews`,
    description: 'Able to lead an interview and effectively evaluate a candidate based on relevant factors while ignoring irrelevant discriminations.',
    weight: 1,
    id: 'interview',
  },
  {
    ...
    description: 'Willing to broach difficult or uncomfortable discussions in an effective way with appropriate timing and context.',
    weight: 1,
    id: 'difficult-topics',
  },
  {
