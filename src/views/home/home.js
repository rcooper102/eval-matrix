...
export class Home extends React.Component {
  render() {
    ...
    return	<div className='Home View'>
        ...
        <p><strong>Scores are based on observation:</strong> We can only evaluate you based on what we observe within the scope of what you do for GroupBy. The opportunity to prove yourself in all facets will come in time.</p>
